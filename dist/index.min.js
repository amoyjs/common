...
o&&h&&(b(h)||(k=Array.isArray(h)))?(k?(k=!1,g=j&&Array.isArray(j)?j:[]):g=j&&b(j)?j:{},l[f]=c(o,g,h)):void 0!==h&&(l[f]=h)}return l}function d(a){var b=0;a.renderer.addListener("prerender",function(){b=0}),a.renderer.addListener("postrender",function(){k=b});var c=a.renderer.gl.drawElements.bind(a.renderer.gl);a.renderer.gl.drawElements=function(){for(var a=[],d=0;d<arguments.length;d++)a[d]=arguments[d];return b++,c.apply(void 0,a)}}function e(){var a=performance.now(),b=0,c=function(){var d=performance.now();b++,d>=1e3+a&&(l=Math.round(1e3*b/(d-a)),b=0,a=d),requestAnimationFrame(c)};c()}function f(a,b){var c=document.createElement("div");c.id="stats",c.style.cssText="position:fixed;\n        left: 3rem;\n        pointer-events: none;\n        user-select: none;\n        z-index:10000;\n        color: #fff;\n        font-size: 3rem;\n        line-height: 3rem;",c.innerHTML=""+(a?"<p id='fps'>fps:</p>":"")+(b?"<p id='drawcalls'>drawCalls:</p>":""),document.body.appendChild(c);var d=document.querySelector("#stats"),e=window.innerHeight-(d?d.clientHeight:0);c.style.top=e-10+"px"}function g(){var a=document.querySelector("#stats");setTimeout(function(){var b=document.getElementById("stats");b&&(b.style.top=window.innerHeight-(a?a.clientHeight:0)-10+"px")},100)}function h(a,b){void 0===b&&(b=["fps","draw-calls"]);var c=b.includes("fps"),h=b.includes("draw-calls");h&&d(a),c&&e(),f(c,h);var i=document.querySelector("#drawcalls"),j=document.querySelector("#fps");setInterval(function(){k&&i&&(i.innerHTML="drawCalls: "+k),l&&j&&(j.innerHTML="fps: "+l)},200),window.addEventListener("resize",function(){return g()})}function j(a){var b={},c=b.toString.call(a);if(null==a)return a+"";"Boolean Number String Function Array Date RegExp Object Error Symbol".split(" ").forEach(function(a){b["[object "+a+"]"]=a.toLowerCase()});return"object"==typeof a||"function"==typeof a?b[c]||"object":typeof a}var k,l,m=function(a,b){return b={exports:{}},a(b,b.exports),b.exports}(function(a){/**
...
//
k.length?this._events[f]=1===k.length?k[0]:k:e(this,f)}return this},f.prototype.removeAllListeners=function(a){var c;return a?(c=h?h+a:a,this._events[c]&&e(this,c)):(this._events=new b,this._eventsCount=0),this},f.prototype.off=f.prototype.removeListener,f.prototype.addListener=f.prototype.on,f.prefixed=h,f.EventEmitter=f,a.exports=f}),n=new m;a.event=n,a.eventify=function(a){return a.callbacks={},a.on=function(b,c){if(!b||!c)return a;!a.hasOwnProperty("callbacks")&&(a.callbacks||(a.callbacks={}));var d,e=b.split(" ");return e.map(function(b){(d=a.callbacks)[b]||(d[b]=[]),a.callbacks[b].push(c)}),a},a.emit=function(){for(var b=[],c=0;c<arguments.length;c++)b[c]=arguments[c];var d=b.shift(),e=d.split(" ");return e.map(function(c){var d=null===a.callbacks?[]:a.callbacks[c]||[];d.length&&d.map(function(c){c&&c.apply(a,b)})}),a},a.off=function(){for(var b=[],c=0;c<arguments.length;c++)b[c]=arguments[c];if(0===b.length)a.callbacks={};else{var d=b.shift(),e=d.split(" ");e.map(function(b){return delete a.callbacks[b]})}return a},a},a.extend=c,a.forin=function(a,b){if("object"==typeof a)for(var c in a)if(a.hasOwnProperty(c)){var d=a[c];b(c,d)}},a.getQuery=function(a){var b=location.search,c=""!==b?b.slice(1):"",d=c.split("&"),e=d.reduce(function(a,b){var c=b.split("="),d=c[0],e=c[1];return a[d]=decodeURIComponent(e),a},{});return e[a]},a.getValue=function(a,b){if("object"!==j(a))return a;for(var c,d=a,e=b.split("."),f=0,g=e.length;f<g;f++)if(c=e[f],c)if(d[c])d=d[c];else{d=void 0;break}return d},a.isEmpty=function(a){return"object"==typeof a?0===Object.keys(a).length:!!(Array.isArray(a)||"string"==typeof a)&&0===a.length},a.setValue=function(a,b,c){if("object"!==j(a))throw new Error("setValue tar muse be a object!");else{var d=b.trim().indexOf(".");if(0<d&&d<b.length-1){for(var e,f=b.trim().split("."),g=a,h="",k=0,m=f.length-1;k<m;k++)e=f[k],"object"==typeof g[e]?g=g[e]:"undefined"==typeof g[e]&&(h=e);if(!h){var l=f[f.length-1];g[l]=c}else throw new Error("the key("+h+") is not in tar obj!")}else a[b.replace(/\./g,"")]=c}},a.showPerformance=function(a){return void 0===a&&(a=["fps","draw-calls"]),function(b){return b.on("created",function(b){var c=b.game;return h(c,a)})}},a.showPerformancePannel=h,a.type=j,a.usesify=function(a){return function(b){var c=Array.isArray(a)?a:[a];c.map(function(c){if("function"==typeof c)c(b);else throw Error("[@amoy/components]error: addon "+a+" must be a function;")})}},Object.defineProperty(a,"__esModule",{value:!0})});
